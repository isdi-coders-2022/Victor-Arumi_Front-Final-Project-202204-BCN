...
describe("Given an App component", () => {
  describe("When its invoked with a Login Page and with a real token (real user Paula Badosa) already in the local storage", () => {
    saveToStorage(
    ...
    test("Then it should render with a token in its local storage and dispatch a login action that will decrypt the token with the user information, which will be in the user state of the store", () => {
